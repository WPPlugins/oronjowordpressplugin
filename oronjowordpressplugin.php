...
/*
Plugin Name: Oronjo Wordpress Plugin
Plugin URI: https://www.oronjo.com/
Description: Automatically populate your Oronjo products into Wordpress.
Author: orangewise
Version: 3.9.7
...
namespace WPSE\oronjowordpressplugin;
...
function oronjo_subpanel() {
  ...
  if (isset($_POST['save_oronjo_settings'])) {
    ...
    echo '<div class="updated"><p>Oronjo Plugin have been saved. If you would like to import your Oronjo products into Wordpress, hit the \'Import Oronjo Products\' button.</p></div>'; 
  }
...
function oronjo_add_action_links ( $links ) {
  $mylinks = array(
  '<a href="' . admin_url('options-general.php?page=oronjowordpressplugin.php') . '">Settings</a>',
  );
...
function oronjo_admin_menu() {
   if (function_exists('add_options_page')) {
     oronjo_setup();
     add_options_page('Oronjo Oronjo Plugin', 'Oronjo Plugin', 8, basename(__FILE__), __NAMESPACE__.'\\oronjo_subpanel');
